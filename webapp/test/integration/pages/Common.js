sap.ui.define([
	...
	return Opa5.extend("comisiones.zcom.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["comisiones/zcom/localService/mockserver"], function (mockserver) {
